        ...
        <div className="productNav-container">
            <nav className="productNav">
                ...
                <section className="navRight">
                    ...
                    <li className="tslaAccountBtn"><a style={{"color": "inherit", "text-decoration": "none"}}href="https://github.com/charleswfloyd3/Tesla-Clone" target="_blank">T3SLA CLONE</a></li>
